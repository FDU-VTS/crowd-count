...
train(model, train_set, test_set, train_loss, test_loss, optim="SGD", saver=saver, cuda_num=[0, 1], train_batch=2,
      test_batch=2, test_crop_size=1, learning_rate=1e-5, enlarge_num=1, scheduler_flag=True)
