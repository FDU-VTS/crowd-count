...
# gt_transform = LabelNormalize(100)
gt_transform = cc_transforms.LabelEnlarge(100)
both_transform = cc_transforms.ComplexCompose([RandomCrop([576, 768]),
                                               RandomHorizontallyFlip()])
# both_transform = Compose([RandomCrop([576, 768]),
#                           RandomHorizontallyFlip()])
...
saver = Saver(path="../exp/2019-1-2-shtu_b-3")
tb = TensorBoard(path="../runs/2019-1-2-shtu_b-3")
