...
train_set = UCFCC50(mode="train", img_transform=img_transform, gt_transform=gt_transform, both_transform=both_transform)
test_set = UCFCC50(mode="test", img_transform=img_transform)
train_loss = AVGLoss()
test_loss = EnlargeLoss(100)
saver = Saver(path="../exp/ucf_cc_50")
