...
class ResNetAttention(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer3 = self._make_layer(Bottleneck, 256, 23, stride=1)
    ...
    def _init_param(self):
        ...
        pretrained_state_dict = nn.Sequential(
            resnet101.conv1, resnet101.bn1, resnet101.relu, resnet101.maxpool,
            resnet101.layer1, resnet101.layer2, resnet101.layer3
        )
        own_state_dict = self.front_end.state_dict()
        own_state_dict.update(pretrained_state_dict.state_dict())
        self.front_end.load_state_dict(own_state_dict)
